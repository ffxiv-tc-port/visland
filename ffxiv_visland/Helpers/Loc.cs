...
// visland never initializes ECommons (ECommonsMain.Init is not called anywhere),
// so we ship this tiny equivalent instead of pulling in the full library just for loc.
public static class Localization {
    ...
    public static void Init(string? directory) {
        ...
        try {
            ...
            Service.Log.Info($"Localization: loaded {Translations.Count} entries from {path}");
        }
        catch (Exception ex) {
